package com.huli.jformatter.intellij.action;

import com.huli.jformatter.intellij.entity.ClassEntity;
import com.huli.jformatter.intellij.process.ClassProcessor;
import com.huli.jformatter.intellij.process.IProcessor;
import com.huli.jformatter.intellij.ui.Toast;
...
public class DataWriter extends WriteCommandAction.Simple {
    ...
    public void execute(ClassEntity targetClass) {
        ...
        ProgressManager.getInstance().run(new Task.Backgroundable(project, "JFormatter") {
            ...
            public void run(@NotNull ProgressIndicator progressIndicator) {
                ...
                sb.append("JFormatter [" + (System.currentTimeMillis() - currentTimeMillis) + " ms]\n");
